...
export default {
  ...
  data() {
    return {
      ...
      travel: [
        { title: '小行星帶體驗宇宙の衝擊震撼５日', content: '搭上 OwlSpace 專屬火箭前往位於火星和木星間的太陽系小行星帶，體驗與數十萬顆小行星摩擦的快感 &gt;&sol;&sol;&sol;&sol;&lt;' },
        { title: '捕捉太陽黑子親子體驗單程票（保證會抓到一顆）', content: '免費租借裝備捕捉太陽黑子！太陽黑子可用在許多地方，不管是家庭配菜用料、五星飯店主菜佐料都可以。太陽黑子最廣為人知的用法是放在貓砂內，讓喵星人知道誰才是主人' }
      ],
      market: [
        { title: '宇宙小灰人醃大腸 10 斤裝', content: '你吃過豬腸、牛肚，但你吃過外星人嗎？全宇宙首批經銀河系食物管理局核定的人道外星人內臟食品首次出現在世人面前！' },
        { title: '火星蟑螂特有種幼體（3 月齡以下）10 隻裝含運', content: '地球小強的剋星！放一隻火星蟑螂在家裡，保證 30 年不會見到任何一隻地球蟑螂！但須特別注意的是火星蟑螂繁殖很快，需謹慎使用' }
      ],
      products: [
